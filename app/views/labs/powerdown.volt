        ...
        <table class="ui small striped table">
          <thead>
            <tr>
              ...
              <th class="right aligned">~<?php echo $this->convert::vest2sp($upcoming_total, " MORPH", 0); ?></th>
            </tr>
          </thead>
          <tbody>
            {% for day in upcoming %}
            <tr>
              ...
              <td class="right aligned">~<?php echo $this->convert::vest2sp($day->withdrawn, " MORPH", 0); ?></td>
            </tr>
            {% endfor %}
          </tbody>
        </table>
        ...
        <table class="ui small striped table">
          <thead>
            <tr>
              ...
              <th class="right aligned">~<?php echo $this->convert::vest2sp($previous_total, " MORPH", 0); ?></th>
            </tr>
          </thead>
          <tbody>
            {% for day in previous %}
      ...
      <div class="column">
        ...
        <table class="ui small striped attached table">
          <thead>
            <tr>
              <th></th>
              <th class="right aligned">MORPH Deposited</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="collapsing right aligned">
                <div class="ui header">
                  +<?php echo $this->largeNumber::format($powerdown->deposited, '', " MORPH", 0); ?>
                  <div class="sub header">
